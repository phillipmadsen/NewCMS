                    ...
                    <div class="col_two_third">
                        ...
                        <div class="col_one_third">
                            ...
                            <div class="widget clearfix">
                                ...
                                <img src="{!! asset('frontend/images/footer-widget-logo.png') !!}" alt="" class="footer-logo">

                                <p>We believe in <strong>Simple</strong>, <strong>Creative</strong> &amp; <strong>Flexible</strong> Manufacturing Standards.</p>

                                <div style="background: asset('{!! url('frontend/images/world-map.png') !!}') no-repeat center center; background-size: 100%;">
                                    <address>
                            ...
                            <div class="spost clearfix">
                                <div class="entry-c">
                                        ...
                                        @if($article->path && $article->file_name)
                                            <a class="nobg" href="{!! URL::route('en.dashboard.article.show', array('slug'=>$article->slug)) !!}" itemprop="url">
